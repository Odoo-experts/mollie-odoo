...
class PaymentAcquirerMethod(models.Model):
    ...
    name = fields.Char(
        "Description", index=True, required=True, translate=True
    )
    ...
    currency_ids = fields.Many2many(
        "res.currency", string="specific Currencies"
    )
    country_ids = fields.Many2many("res.country", string="specific Countries")
